...
const Sidebar = () => {
    ...
    return (
        <aside className={`fixed top-0 w-64 ${isDrawerOpen ? "left-0" : "-left-full"} transition-all overflow-hidden h-full z-40`} aria-label="Sidenav"
        >
            <Menu />
            <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20">
                ...
                <SlideToogle isDarkMode={isDarkMode} toggle={handleTheme} />
            </div>
        </aside>
    )
}
